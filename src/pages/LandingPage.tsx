...
import { ArrowRight, CheckCircle, Beaker, FileCheck, LineChart, AlertTriangle, ArrowUpRight } from 'lucide-react';
...
const LandingPage: React.FC<LandingPageProps> = ({ podioAuthError }) => {
  return (
    <MainLayout>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button asChild size="lg" className="bg-white hover:bg-gray-100 text-blue-700 font-semibold shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
            ...
            <div className="hidden lg:block">
              <div className="relative p-4">
                <div className="absolute inset-0 bg-white/5 rounded-3xl border border-white/10 backdrop-blur-sm transform -rotate-3 scale-105"></div>
                <div className="relative bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-6 shadow-2xl transform rotate-2 overflow-hidden">
                  <img 
      ...
      {/* Features Section - More engaging with better visual hierarchy */}
      <div id="features" className="bg-white py-20 md:py-32 relative">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Feature Card 1 */}
            <div className="bg-gradient-to-br from-white to-blue-50 p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 hover:translate-y-[-8px] group">
              ...
              <div className="pt-4 mt-auto">
                <Button asChild variant="link" className="p-0 text-blue-600 font-medium hover:text-blue-800">
      ...
      {/* Testimonial Section - New section to add social proof */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-5">
              <div className="md:col-span-2 bg-blue-600 p-8 flex items-center justify-center">
                <img 
                  ...
                  onError={(e) => {
                    e.currentTarget.onerror = null;
                    e.currentTarget.src = 'https://placehold.co/600x800/0078D7/FFFFFF?text=Honey+Production';
                  }}
                />
              </div>
              <div className="md:col-span-3 p-8 md:p-12 flex flex-col justify-center">
                <div className="mb-6">
                  <svg width="120" height="24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 0L14.6942 8.2918H23.4127L16.3593 13.4164L19.0534 21.7082L12 16.5836L4.94658 21.7082L7.64074 13.4164L0.587322 8.2918H9.30583L12 0Z" fill="#FFB800" />
                    <path d="M36 0L38.6942 8.2918H47.4127L40.3593 13.4164L43.0534 21.7082L36 16.5836L28.9466 21.7082L31.6407 13.4164L24.5873 8.2918H33.3058L36 0Z" fill="#FFB800" />
                    <path d="M60 0L62.6942 8.2918H71.4127L64.3593 13.4164L67.0534 21.7082L60 16.5836L52.9466 21.7082L55.6407 13.4164L48.5873 8.2918H57.3058L60 0Z" fill="#FFB800" />
                    <path d="M84 0L86.6942 8.2918H95.4127L88.3593 13.4164L91.0534 21.7082L84 16.5836L76.9466 21.7082L79.6407 13.4164L72.5873 8.2918H81.3058L84 0Z" fill="#FFB800" />
