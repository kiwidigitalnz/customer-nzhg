        ...
        <CardContent className="pt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div>
                <h4 className="text-sm font-medium text-muted-foreground mb-1">Product Protection</h4>
                <p className="font-medium">{details.productProtection || "N/A"}</p>
              </div>
            </div>
            <div className="space-y-4">
              <div>
              ...
              <div>
                <h4 className="text-sm font-medium text-muted-foreground mb-1">Loading Method</h4>
                <p className="font-medium">{details.loadingMethod || "N/A"}</p>
              </div>
            </div>
          </div>
        </CardContent>
